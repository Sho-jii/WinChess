...
namespace Chess{
    ...
    public partial class Tile : UserControl{
        ...
        public Color TileColor() => color != ChessColor.WHITE ? Color.SaddleBrown : Color.SandyBrown;
        ...
        public void PossibleMove(bool show){
            Bitmap resizedImage = new Bitmap(Properties.Resources.PossibleM, new Size(48, 48));
            PieceImage.SizeMode = PictureBoxSizeMode.CenterImage;
            if (!show) PieceImage.Image = null;
            else PieceImage.Image = resizedImage;          
        }
